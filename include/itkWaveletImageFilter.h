...
#ifndef itkWaveletImageFilter_h
#define itkWaveletImageFilter_h

#include "itkWaveletOperator.h"
#include "itkWaveletFilterBank.h"
#include "itkWaveletTransform.h"
#include "itkWaveletsBandsListToWaveletsSynopsisImageFilter.h"
...
public:
  ...
  typedef itk::WaveletOperator< TMotherWaveletOperator, itk::Wavelet::FORWARD, InputPixelType, ImageDimension >
    WaveletOperatorType;
  typedef itk::WaveletFilterBank< InputImageType, InputImageType, WaveletOperatorType, itk::Wavelet::FORWARD >
    FilterBankType;
  typedef itk::WaveletTransform< InputImageType, InputImageType, FilterBankType, itk::Wavelet::FORWARD >
  ...
  typedef itk::WaveletsBandsListToWaveletsSynopsisImageFilter<WaveletTransformFilterOutputImageListType, OutputImageType>
