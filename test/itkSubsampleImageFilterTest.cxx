...
int itkSubsampleImageFilterTest(int itkNotUsed(argc), char * argv[])
{
  ...
  typedef itk::SubsampleImageFilter<ImageType, ImageType, itk::Wavelet::INVERSE>
  InvFilterType;
  ...
  typedef itk::SubsampleImageFilter<ImageType, ImageType, itk::Wavelet::FORWARD>
  ForwardFilterType;
